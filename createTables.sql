...
CREATE TABLE IF NOT EXISTS Programs (
    ...
    pr_description VARCHAR(1023) NULL,
...
DELETE FROM sqlite_sequence WHERE name='PointOpp';
CREATE TABLE IF NOT EXISTS PointOpp (
    ...
    po_pointsPossible INT NULL
);

DROP TABLE IF EXISTS PointHistory;
DELETE FROM sqlite_sequence WHERE name='PointHistory';
CREATE TABLE IF NOT EXISTS PointHistory (
    ...
    ph_actualPointsEarned INT NULL
);

DROP TABLE IF EXISTS ItemsBought;
DELETE FROM sqlite_sequence WHERE name='ItemsBought';
